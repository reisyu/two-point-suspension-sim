...
> **重要：張力の読み方**
> 画面の張力は、部材の重さを **1 kg（＝9.81 N）** として計算した値です。実際の値に直すには次のようにしてください。
>
> **実際の張力 ＝ 画面の張力 ÷ 9.81 × 部材の実重量**
>
> 例：画面が `T₁ = 8.47 N` で、部材が 2.0 t なら → 8.47 ÷ 9.81 × 2.0 t ＝ **約 1.73 t**
>
> 「画面の張力 ÷ 9.81」がそのまま **全体重量に対する割合** になります（上の例なら 86%）。
...
- **重量は 1 kg に正規化**されています。張力は上の「張力の読み方」で実重量に換算してください。
