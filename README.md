...
吊り点・取付点・ワイヤー長を固定したまま、**外形だけ**を大きく変えて計算しました。回りにくさ（慣性モーメント）は 0.0039 〜 4.33 と **1100倍** の開きがあります。

| 外形 | 回りにくさ | 重心高さ | 姿勢 | 張力の配分 |
|---|---|---|---|---|
| 長方形 | 0.075 | 1.51958278 m | 18.849329° | 42.64% / 58.16% |
| 細長い棒 | 0.4803 | 同左 | 同左 | 同左 |
| 小さな三角形 | 0.00389 | 同左 | 同左 | 同左 |
| 巨大な矩形 | 4.33333 | 同左 | 同左 | 同左 |

**8桁まで完全に一致**しました。揺れている**途中**の動きだけは外形で変わりますが、**止まる位置は同じ**です。

（張力の配分を足すと 100.8% になりますが、これは誤差ではありません。ワイヤーが傾いているぶん、2本の合計は部材の重さより大きくなります＝「[2. どちらのワイヤーに力が寄るか](#2-どちらのワイヤーに力が寄るか)」の吊り角の話です。）
